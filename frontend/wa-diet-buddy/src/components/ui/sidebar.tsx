  ...
  ({ className, ...props }, ref) => {
    return (
      <main
        ref={ref}
        className={cn(
          // min-w-0 overrides the flex item default of min-width:auto, which otherwise lets a
          // wide descendant (e.g. a data table with many/wide columns) force this whole flex
          // item — and with it the shared row containing the sidebar — wider than the viewport,
          // producing a document-level horizontal scrollbar that drags the sidebar/header along
          // instead of leaving them in place while just the offending content scrolls.
