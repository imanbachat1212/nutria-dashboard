...
export const createMealSchema = z.object({
  body: z.object({
    ...
    totalVitaminA: z.number().min(0).nullable().optional(),
    totalVitaminC: z.number().min(0).nullable().optional(),
    totalVitaminD: z.number().min(0).nullable().optional(),
    totalVitaminE: z.number().min(0).nullable().optional(),
    totalVitaminK: z.number().min(0).nullable().optional(),
    totalVitaminB1: z.number().min(0).nullable().optional(),
    totalVitaminB2: z.number().min(0).nullable().optional(),
    totalVitaminB3: z.number().min(0).nullable().optional(),
    totalVitaminB5: z.number().min(0).nullable().optional(),
    totalVitaminB6: z.number().min(0).nullable().optional(),
    totalVitaminB12: z.number().min(0).nullable().optional(),
    totalFolate: z.number().min(0).nullable().optional(),
    totalCalcium: z.number().min(0).nullable().optional(),
    totalIron: z.number().min(0).nullable().optional(),
    totalMagnesium: z.number().min(0).nullable().optional(),
    totalPhosphorus: z.number().min(0).nullable().optional(),
    totalPotassium: z.number().min(0).nullable().optional(),
    totalSodium: z.number().min(0).nullable().optional(),
    totalZinc: z.number().min(0).nullable().optional(),
    totalCopper: z.number().min(0).nullable().optional(),
    totalManganese: z.number().min(0).nullable().optional(),
